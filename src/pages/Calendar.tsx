...
import { Calendar as CalendarIcon, ChevronLeft, ChevronRight, Clock, Plus, User } from 'lucide-react';
    ...
    <Layout>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Calendar */}
          <div className="lg:col-span-2 bg-card rounded-lg card-shadow overflow-hidden animate-fade-in">
